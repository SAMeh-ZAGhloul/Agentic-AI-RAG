...
def setup_document_tool(file_dir, session_id=None, milvus_uri="http://localhost:19530"):
    ...
    vector_store = QdrantVectorStore(location=":memory:", collection_name=collection_name, embed_dim=384)
    ...
    # Create a query engine for the vector index with reranker
    docs_query_engine = vector_index.as_query_engine(
        text_qa_template=qa_template,
        similarity_top_k=5, # Retrieve more for reranking
